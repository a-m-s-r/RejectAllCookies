...
test(
  'rejects a dynamically inserted banner without accepting and persists on reload',
  async ({ page }: { page: any }) => {
...
test(
  'popup exposes local controls and a truthful status',
  async ({ page, extensionId }: { page: any; extensionId: string }) => {
